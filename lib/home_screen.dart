...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Live Scores'), actions: [
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  trailing: Text(
                    '${footballMatch.team1Score} vs ${footballMatch.team2Score}',
                  ),
                  subtitle: Text(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          // FirebaseFirestore.instance.collection('football').doc('usvschina').set({
          //   'team1_name': 'USA',
          //   'team1_score': 0,
          //   'team2_name': 'China',
          //   'team2_score': 34,
